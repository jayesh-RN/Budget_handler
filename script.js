...
function checkAmmountInputs() {
  ...
  if (
    incomeSource.value.trim() != 0 &&
    incomeType.value.trim() != 0 &&
    ...
    html += `
        ...
        <div class="item">
            <div class="iconDetails">
                ...
                }" class="transIcon" name=${
      item.obj == "product" ? "pricetag" : "cash"
    }></ion-icon>
            ...
            <div class="itemDetails">
                <span style="${
                  item.obj == "product" ? "color: red" : "color: green"
                }" class="itemPrice">
...
function calculateIncome() {
  ...
  let totalIncome = income
    .map((cash) => cash.ammount)
    .reduce((total, cash) => Number(cash) + Number(total), 0);
  return totalIncome;
}
...
function calculateExpense() {
  ...
  let totalExpense = expense
    .map((spent) => spent.cost)
    .reduce((total, spent) => Number(spent) + Number(total), 0);
  return totalExpense;
}
